...
public class Solver
{
    ...
    int basX,bitX,basY,bitY;
    

    public Solver(char[][] feild ,int basX, int basY, int bitX, int bitY)
    {
    ...
    public boolean nearExit()
    {
        ...
        else if (x == bitX+1 && y == bitY) {
        	return true;
		}
        else if (x == bitX && y == bitY-1) {
        	return true;
		}
        else if (x == bitX && y == bitY+1) {
        	return true;	
    ...
    public void goToExit()
    {
       ...
       // Integer[] current = path.peek(); //gets the current location
        ...
        temp[0] = bitX;   //exit is to the right of the current location
        temp[1] = bitY;
